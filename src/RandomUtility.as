package 
{
	...
	public class RandomUtility
	{
		...
		//获取随机范围
		public static function randomRange(ar:Array):Number{
		 ...
		 * 
		 */		
		public static function randomFromArray(ary:Array):Object
		{
			if(null == ary) return 0;
			var len:int = ary.length;
			var index:int = integer(len);
			return ary[index];
		}
		
		public static function randomTrueOrFalse():Boolean
		{
			var num:Number = range(1,3);
